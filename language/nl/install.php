...
$lang = array_merge($lang, array(
	...
	'SUPPORT_BODY'		=> 'Volledige ondersteuning word gegegeven voor de huidige stabiele versie van phpBB, helemaal gratis. Dit is inclusief:</p><ul><li>installatie</li><li>Configuratie</li><li>iechnische vragen</li><li>problemen die zijn gerelateerd aan potentiële fouten in de software</li><li>Updaten van een Release Candidate (RC) versie naar de laatste stabiele versie</li><li>converteren van phpBB 2.0.x naar phpBB3</li><li>converteren from andere forumsortware naar phpBB3 (zie het <a href="https://www.phpbb.com/community/viewforum.php?f=486">Convertors Forum</a>)</li></ul><p>We moedigen gebruikers die nog steeds Beta versies van phpBB3 gebruiken aan om die installatie zo snel mogelijk te vervangen met een verse kopie van de laatste versie.</p><h2>Extensies / Stijlen</h2><p>Voor problemen gerelateerd aan stijlen plaats een bericht in het daarvoor bedoelde <a href="https://www.phpbb.com/community/viewforum.php?f=451">Extensies Forum</a>.<br />Voor problemen gerelateerd aan stijlen, templates en themes, plaats een bericht in het daarvoor bestemde <a href="https://www.phpbb.com/community/viewforum.php?f=471">Stijlen Forum</a>.<br /><br />Als je vraag gerelateerd is aan een bepaald pakket (package), plaats dan een direct een bericht in het onderwerp van dat pakket.</p><h2>Ondersteuning verkrijgen</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">Het phpBB Welkomst Pakket</a><br /><a href="https://www.phpbb.com/support/">Ondersteunings sectie</a><br /><a href="https://www.phpbb.com/support/docs/en/3.1/ug/quickstart/">Snel Start Gids</a><br /><br />Om je ervan te verzekeren dat je bij blijft met het laatyste nieuws en de laatste versies kun je je <a href="https://www.phpbb.com/support/">abonneren op onze mailing list</a>.<br /><br />',
...
$lang = array_merge($lang, array(
	...
	'COULD_NOT_FIND_PATH'		=> 'Kan het pad naar je oude forum niet vinden. Controleer je instellingen en probeer het opnieuw.<br />» %s is opgegeven als het bronpad.',
